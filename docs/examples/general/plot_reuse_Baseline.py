...
:doc:`polynomial methods <../../../user_guide/algorithms/algorithms_1d/polynomial>` will only
compute the Vandermonde matrix, and potentially its pseudoinverse, once. Likewise,
:doc:`spline methods <../../../user_guide/algorithms/algorithms_1d/spline>` will only have to
compute the spline basis matrix once. Note that this only applies if the same non-data parameters
