...
alternatively be added as an :doc:`optimizer-type algorithm <../../../user_guide/algorithms/algorithms_1d/optimizers>`,
...
1. Methods that directly support masking by inputting the mask as weights, which includes
   all :doc:`classification <../../../user_guide/algorithms/algorithms_1d/classification>` and
   :doc:`polynomial <../../../user_guide/algorithms/algorithms_1d/polynomial>` methods except for :meth:`~.Baseline.loess`
...
2. Methods that do iterative reweighting, such as
   ...
   :doc:`spline methods <../../../user_guide/algorithms/algorithms_1d/spline>`, :meth:`~.Baseline.loess` and
...
# :doc:`classification methods <../../../user_guide/algorithms/algorithms_1d/classification>` use different
