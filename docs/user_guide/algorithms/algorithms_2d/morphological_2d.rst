...
:meth:`~.Baseline2D.mor`:
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/morphological:mor (Morphological)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/morphological:imor (Improved Morphological)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/morphological:rolling_ball (Rolling Ball)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/morphological:tophat (Top-hat Transformation)>`.
