...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:mixture_model (Mixture Model)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:irsqr (Iterative Reweighted Spline Quantile Regression)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_asls (Penalized Spline Version of asls)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_iasls (Penalized Spline Version of iasls)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_airpls (Penalized Spline Version of airpls)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_arpls (Penalized Spline Version of arpls)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_iarpls (Penalized Spline Version of iarpls)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_psalsa (Penalized Spline Version of psalsa)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_brpls (Penalized Spline Version of brpls)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/spline:pspline_lsrpls (Penalized Spline Version of lsrpls)>`.
