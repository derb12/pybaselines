...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/polynomial:poly (Regular Polynomial)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/polynomial:modpoly (Modified Polynomial)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/polynomial:imodpoly (Improved Modified Polynomial)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/polynomial:penalized_poly (Penalized Polynomial)>`.
...
:ref:`explanation for the algorithm <user_guide/algorithms/algorithms_1d/polynomial:quant_reg (Quantile Regression)>`.
