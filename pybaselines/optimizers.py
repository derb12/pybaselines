...
class _Optimizers(_Algorithm, _OptimizersNDMixin):
    ...
    def custom_bc(self, data, method='asls', regions=((None, None),), sampling=1, lam=None,
        ...
        """
        y, optimizer_obj, method_kws = self._setup_optimizer(
            data, method, method_kwargs=method_kwargs, copy_kwargs=True
        )
        ...
        new_fitter = optimizer_obj.fitter._override_x(x_fit)
        baseline_fit, params['method_params'] = getattr(new_fitter, optimizer_obj.method)(
            y_fit, **method_kws
        )
